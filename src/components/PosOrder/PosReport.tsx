...
function StatCard({
  ...
  return (
    <div
      className={`rounded-xl border p-4 flex items-center gap-3 ${bgMap[color] || bgMap.blue} bg-opacity-60`}
    >
      <div
        className={`rounded-lg p-2.5 shrink-0 ${iconBgMap[color] || iconBgMap.blue}`}
      >
                  ...
                  {report.paymentBreakdown.map((p, i) => {
                    ...
                    return (
                      <div key={i} className='flex items-center gap-3'>
                        <span className='text-xs font-medium text-gray-600 w-20 shrink-0 uppercase'>
                          {p.method}
                        </span>
                          ...
                          <td colSpan={4} className='p-0'>
                            <div className='px-4 pb-3 pt-2 space-y-3'>
                              {p.orderDetails.map((order) => (
                                ...
                                >
                                  {/* Order header */}
                                  <div className='flex items-center justify-between bg-gray-100/80 px-3 py-2 border-b border-gray-200'>
