...
import {
  LuSearch, LuPlus, LuRefreshCw, LuShoppingCart, LuPencil, LuBan, LuCircleCheck, LuX, LuEye,
} from 'react-icons/lu';
    ...
    <div className="space-y-6">
      ...
      <Card className="p-4 border-slate-100 shadow-sm">
        <div className="flex flex-wrap items-center gap-3">
          ...
          {(searchTerm || selectedStatus || selectedSupplier || selectedLocation) && (
            <button
              type="button"
              onClick={() => {
                setSearchTerm("");
                        ...
                        >
                          ...
                          {po.status === 'DRAFT' && (
                            <>
                              ...
                              <DropdownMenuItem
                                onClick={() => router.push(`/inventory/purchases/edit/${po.id}`)}
                          ...
                          {(po.status === 'DRAFT' || po.status === 'PENDING') && (
                            ...
                            >
                              <LuCircleCheck className="h-3.5 w-3.5" /> Approve PO
                            </DropdownMenuItem>
                          )}
                          {(po.status === 'DRAFT' || po.status === 'PENDING') && (
                            <>
